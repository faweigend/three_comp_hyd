class ConstantEffortMeasures:
    """
    Used to consistently store efforts with time points. This can be used use for
    MMP(Mean Maximal Power), TTE(Time To Exhaustion) estimations or
    Lactate measures for VO2 tests
    """
